        ...
        <Row>
          ...
          <Col lg={10} className="footer-info">
            <p>
              ...
              preserving Bihar's cultural heritage while simultaneously creating
              new opportunities for education, employment, and economic growth.
              <br />
              <br />
              Bihar International Trade Organization (BITO) Preserving Heritage,
              Creating Opportunities Explore the rich tapestry of Bihar's
              history and culture, where the past meets the future. BITO is your
              gateway to a rejuvenated Bihar, dedicated to preserving its
              heritage while paving the way for progress.
            </p>
          </Col>
        </Row>
          ...
          <Col lg={4}>
            <div className="address-div pe-2">
              <p className="address-para">
                ...
                City Metro Station, Noida-201309 <br/>Phone: 0120-4914498
              </p>
              <p className="email">
